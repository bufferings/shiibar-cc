...
use shiibar_proto::{HookEvent, ReportPayload, Status};
use shiibard::clock::FakeClock;
use shiibard::core::{BroadcastEvent, Core, BROADCAST_CAPACITY};
...
fn session_start(target: &str, session_id: &str, ts: i64) -> ReportPayload {
    ReportPayload {
        ...
        ts,
        source: Some(shiibar_proto::SessionStartSource::Startup),
